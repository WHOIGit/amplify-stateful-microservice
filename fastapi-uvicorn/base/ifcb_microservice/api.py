...
def create_app(processor: BaseProcessor) -> FastAPI:
    """
    ...
    Example:
        >>> from ifcb_microservice import create_app, BaseProcessor
    ...
    async def lifespan(app: FastAPI):
        ...
        # Startup
        logger.info(f"Starting {processor.name} Microservice v{processor.version}")
    ...
    app = FastAPI(
        title=f"{processor.name.title()} Microservice",
        description=f"IFCB {processor.name} processing service",
